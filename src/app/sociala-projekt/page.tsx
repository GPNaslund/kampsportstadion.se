    ...
    <main className="flex min-h-screen min-w-screen flex-col items-center justify-between">
      ...
      <div className="w-full">
        <div className="w-full h-screen flex flex-col mt-40 items-center w-900:px-40">
          ...
          <p className="text-lg text-center mt-5 px-5 w-900:text-3xl">Vill du vara med och sponsra våra sociala projekt?</p>
          <p className="text-lg text-center mt-5 px-5 w-900:text-3xl">Vi som förening brinner för att barn och ungdomsidrott ska vara tillgängligt för alla oavsett bakgrund. Tyvärr har det för 

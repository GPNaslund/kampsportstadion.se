...
// Transcribed from schema-vt26.jpg. Edit here, the site updates everywhere.
...
export const SCHEDULE: Session[] = [
  ...
  { day: 'mon', start: '17.00', end: '18.00', title: 'Barn BJJ Steg 2',       family: 'bjj', isKids: true },
  { day: 'mon', start: '17.00', end: '18.00', title: 'Thaiboxning Tävling',   family: 'thai' },
  { day: 'mon', start: '18.00', end: '19.30', title: 'BJJ Mixgrupp',          family: 'bjj' },
  { day: 'mon', start: '18.00', end: '19.00', title: 'Thaiboxning Steg 2',    family: 'thai' },
  { day: 'mon', start: '19.00', end: '20.00', title: 'Thaiboxning Steg 1',    family: 'thai' },
  ...
  { day: 'wed', start: '17.00', end: '17.45', title: 'Barn Thaiboxning',            family: 'thai', isKids: true, ageNote: '7–9 år' },
  { day: 'wed', start: '17.00', end: '18.00', title: 'BJJ Barn Steg 2 + Ungdomar',  family: 'bjj',  isKids: true },
  { day: 'wed', start: '17.00', end: '18.00', title: 'Thaiboxning Tävling',         family: 'thai' },
  { day: 'wed', start: '18.00', end: '19.00', title: 'BJJ Steg 2',                  family: 'bjj' },
  { day: 'wed', start: '18.00', end: '19.00', title: 'Thaiboxning Steg 2',          family: 'thai' },
  { day: 'wed', start: '19.00', end: '20.00', title: 'Thaiboxning Steg 1',          family: 'thai' },
  ...
  { day: 'thu', start: '19.00', end: '20.00', title: 'Thaiboxning Steg 1+2', family: 'thai' },

  // ── Fredag
  { day: 'fri', start: '12.00', end: '12.45', title: 'Kampsportfys',  family: 'fys' },
  { day: 'fri', start: '15.00', end: '16.00', title: 'After School',  family: 'thai', isKids: true },
  ...
  { day: 'sat', start: '12.00', end: '12.45', title: 'Barn Kampsportlek 1',   family: 'thai', isKids: true, ageNote: '4–6 år' },
  { day: 'sat', start: '12.00', end: '12.45', title: 'Barn Thaiboxning',      family: 'thai', isKids: true, ageNote: '7–9 år' },
  { day: 'sat', start: '13.00', end: '13.45', title: 'Barn Kampsportlek 2',   family: 'thai', isKids: true, ageNote: '4–6 år' },
  ...
  { day: 'sun', start: '11.00', end: '12.00', title: 'BJJ Nybörjare Steg 1',   family: 'bjj' },
  { day: 'sun', start: '12.00', end: '13.00', title: 'BJJ No Gi Sparring',     family: 'bjj' },
  { day: 'sun', start: '12.00', end: '13.00', title: 'MMA Tävlingsgrupp',      family: 'mma' },
];
